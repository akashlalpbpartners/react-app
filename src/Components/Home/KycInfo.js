    ...
    <>
      ...
      >
        <div className="container custom-choose-file">
          <div id="message" className={messageStyle}>{message}</div>
          <div className="row">
            <form>
              <div className="col-md-12">
                ...
                <span id="pan_card_file" className={panCardName?"my-input m-3":""}>
                  {panCardName}{" "}
                </span>
              </div>
              <div className="col-md-12">
                ...
                <span id="cancel-cheque_file" className={cancelChequeName?"my-input m-3":""}>
                  {cancelChequeName}{" "}
                </span>
              </div>
              <div className="col-md-12">
                ...
                <span id="address_proof_file" className={addressProofName?"my-input m-3":""}>
                  {addressProofName}{" "}
                </span>
              </div>
              <div className="col-md-12">
                ...
                <span id="highest_education_file" className={highestEducationName?"my-input m-3":""}>
              ...
              <div className="col-md-12">
                ...
                <span id="partner_photo_file" className={partnerPhotoName?"my-input m-3":""}>
                  {partnerPhotoName}{" "}
                </span>
              </div>
              <div className="col-md-12">
                ...
                <span id="msmecertificate_file" className={msmeCertificateName?"my-input m-3":""}>
                  {msmeCertificateName}{" "}
                </span>
              </div>
              <div className="col-md-12">
                ...
                <span id="gstcertificate_file" className={gstCertificateName?"my-input m-3":""}>
                  {gstCertificateName}{" "}
                </span>
              </div>
              <button type="reset" className="btn btn-warning m-2" onClick={handleReset}>
                Reset
              </button>
              <button
                type="button"
